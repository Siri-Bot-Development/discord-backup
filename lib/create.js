                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    ...
                                    _c.label = 1;
                                case 1:
                                    if (!(_i < categories_1.length))
                                        return [3 /*break*/, 9];
                                    category = categories_1[_i];
                                    categoryData = {
                                        name: category.name,
                                        permissions: util_1.fetchChannelPermissions(
                                            category,
                                        ),
                                ...
                                case 4:
                                    return [
                                        4 /*yield*/,
                                        util_1.fetchVoiceChannelData(child),
                                    ];
                                case 5:
                                    channelData = _c.sent();
                                    categoryData.children.push(channelData); // And then push the child in the categoryData
                                ...
                                case 12:
                                    return [
                                        4 /*yield*/,
                                        util_1.fetchVoiceChannelData(channel),
                                    ];
                                case 13:
                                    channelData = _c.sent();
                                    channels.others.push(channelData); // Update channels object
